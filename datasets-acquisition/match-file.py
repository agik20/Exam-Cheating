...
images_input = r"E:\Videos\dataset\pose\70\test"
labels_input = r"E:\Videos\dataset\pose\80\labels\test"
output_match_dir = r"Downloads\0702"
...
if orphan_images:
    print("\n[WARNING] Orphan Images (tanpa label):")
    for name in orphan_images:
        print(" -", image_files[name])

if orphan_labels:
    print("\n[WARNING] Orphan Labels (tanpa image):")
