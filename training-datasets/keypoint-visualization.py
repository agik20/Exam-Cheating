...
# Path direktori
img_dir = r"C:\Users\HeimTech\Documents\Tugas Akhir\Final Project\capstone\inference\frame\images"
label_dir = r"C:\Users\HeimTech\Documents\Tugas Akhir\Final Project\capstone\inference\frame\labels"
output_dir = r"C:\Users\HeimTech\Documents\Tugas Akhir\Final Project\capstone\inference\frame\visualize"
...
class_colors = {
    0: (255, 0, 0),    # Red for no-cheating
    1: (0, 255, 0),    # Green for provide-object
    2: (0, 0, 255)     # Blue for see-friends-work
}
...
def parse_yolo_line(line):
    ...
    if len(values) < 44:
        print(f"Warning: Invalid line format, expected at least 44 values, got {len(values)}")
        return None, None
...
print(f"Using image dimensions: {img_w}x{img_h}")
...
for label_path in label_files:
    ...
    try:
        ...
        for line_num, line in enumerate(lines):
            ...
            if class_id is None:
                print(f"Skipping invalid line {line_num + 1} in {label_path}")
                continue
...
print(f"Visualization complete! {processed_count} images processed and saved to output folder.")
